...
$(function () {       
    $("#SaveTriage").click(function () {
        ...
        // Triage template
        var templateId = 'triage';

        var sessionId = getSessionId();
        var ehrId = ehrID;

        var compositionData = {
            "vitalparametrar": { "vitalparametrar": [{ "indirect_oximetry": [{ "any_event": [{ "spo2": [] }] }], "body_temperature": [{ "any_event": [{ "temperature": [] }] }], "body_weight": [{ "any_event": [{ "weight": [] }] }], "pulse_heart_beat": [{ "any_event": [{ "pulse_rate": [{ "|magnitude": 80, "|unit": "/min" }] }], "method": [] }], "blood_pressure": [{ "any_event": [{ "systolic": [{ "|magnitude": 100, "|unit": "mm[Hg]" }], "diastolic": [{ "|magnitude": 97, "|unit": "mm[Hg]" }] }] }], "respirations": [{ "any_event": [{ "rate": [] }] }] }] }, "ctx": { "language": "sv", "territory": "SE" }
        };
