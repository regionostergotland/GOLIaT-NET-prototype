    ...
    function createFormModule(formName, formVersion, formModel, context, fixedName) {
            ...
            return {
                ...
                createSaveContext: function (context, valueModel) {
                    ...
                    //if (ctx.language) {
						...
						valueModel.ctx.language = "sv";
                    //}

                    //if (ctx.territory) {
                        //valueModel.ctx.territory = ctx.territory;
						valueModel.ctx.territory = "SE";
                    //}
        ...
        module.directive("ehrText", ["EhrContext", "EhrLayoutHelper", function (EhrContext, EhrLayoutHelper) {
            return {
                ...
                controller: function ($scope) {
                    ...
                    //if($scope.model.children["0"].children[1].children["0"].children["0"].inputs["0"].list)
                    $scope.codeValue = function (value) {
                        var codeValue = $scope.model.codeValue(value, EhrContext.language);
            ...
            return {
                ...
                controller: function ($scope) {
                    ...
                    $scope.textValue = function (value) {
                        ...
                        return textValue === undefined || textValue === null ? "" : textValue;
                    };
                }
            };
        }]);
        ...
        module.directive("ehrMultiMedia", ["EhrContext", function (EhrContext) {
            return {
                ...
                controller: function ($scope) {
                    $scope.suppressLabel = false;
                    $scope.multimediaValue = function (value) {

                        return $scope.model.multimediaValue(value);
                    };
                }
            };
        }]);
            ...
            return {
                ...
                controller: function ($scope) {
                    ...
                    $scope.uriValue = function (value) {
                        return $scope.model.uriValue(value);
                    };
                }
            };
        }]);
