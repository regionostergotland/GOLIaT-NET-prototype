...
thinkehr.f4.ComboboxTextModel = thinkehr.f4.NodeModel._extendM({
    init: function (properties) {
        this._super(properties);
    },
     ...
     */
    toString: function () {
        return "thinkehr.f4.ComboboxTextModel/" + this.getName() + "/" + this.getRmType().toString();
    }
});
...
thinkehr.f4.ParsableModel = thinkehr.f4.DirectValueModel._extendM({
     ...
     */
    toString: function () {
        return "thinkehr.f4.ParsableModel/" + this.getName() + "/" + this.getRmType().toString();
    }
});


thinkehr.f4.MultimediaModel = thinkehr.f4.DirectValueModel._extendM({
    init: function (properties) {
        this._super(properties);
    },

    multimediaValue: function (value) {
        if (value !== undefined) {
            ...
            var dv = this.getDefaultValue();
            if (thinkehr.f4.util.isString(dv.value) && dv.value.length > 0) {
                return this.multimediaValue(dv.value);
            }
        }
     ...
     */
    toString: function () {
        return "thinkehr.f4.MultimediaModel/" + this.getName() + "/" + this.getRmType().toString();
    }
});


thinkehr.f4.UriModel = thinkehr.f4.DirectValueModel._extendM({
    init: function (properties) {
        this._super(properties);
    },

    uriValue: function (value) {
        if (value !== undefined) {
     ...
     */
    toString: function () {
        return "thinkehr.f4.UriModel/" + this.getName() + "/" + this.getRmType().toString();
    }
});
...
thinkehr.f4._rmTypeToClassMap = {
    ...
    "DV_PARSABLE": thinkehr.f4.ParsableModel,
    "DV_URI": thinkehr.f4.UriModel,
    "DV_MULTIMEDIA": thinkehr.f4.MultimediaModel,
    "STRING": thinkehr.f4.TextFieldModel
};
