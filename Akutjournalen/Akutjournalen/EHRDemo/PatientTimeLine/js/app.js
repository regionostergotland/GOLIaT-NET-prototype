$(document).ready(function () {
    ...
    var ehrId = EHRID; //"b3b2aaad-8a79-4441-a499-8895a531da29";

    var username = 'lio.se2';
    var password = 'ehr4lio.se2';
    ...
    login().done(function () {
        ...
        //$(".well.demographics").hide()
        //$(".patient-stats.well").hide()
        //$(".panel.panel-danger").hide()
        //$(".panel.panel-warning").hide()

        //$(".panel.panel-info").hide()
        //$(".panel.panel-success").hide()
